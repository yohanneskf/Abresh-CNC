...
export default function ContactList({
  ...
  const handleDownload = async (url: string) => {
    try {
      ...
      link.href = blobUrl;
      link.download = `CNC_DATA_${selectedSubmission?.name || "EXPORT"}.jpg`;
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 md:p-4">
            ...
            >
              ...
              <div className="flex justify-between items-center p-4 md:p-6 border-b border-white/5 bg-amber-500/[0.02]">
                ...
                <button
                  onClick={() => setSelectedSubmission(null)}
                  className="text-gray-500 hover:text-white p-2 border border-white/5 md:border-transparent"
                >
                  <FiX size={20} />
                </button>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <div className="lg:col-span-7 space-y-6">
                    ...
                    <div className="bg-amber-500/[0.03] border border-amber-500/10 p-5">
                      <h4 className="text-[8px] font-black text-amber-500 uppercase mb-3 tracking-widest">
                        Technical_Brief
                      </h4>
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-gray-500 text-[10px] uppercase mb-8">
                This action is irreversible for ID_
                {submissionToPurge.id.slice(-5)}
              </p>
              <div className="grid grid-cols-2 gap-4">
                <button
                  onClick={() => setSubmissionToPurge(null)}
                  disabled={isProcessing}
                  className="py-3 border border-white/10 text-gray-500 text-[10px] font-black uppercase hover:bg-white/5 hover:text-white transition-colors"
                >
                  Cancel
                </button>
                <button
